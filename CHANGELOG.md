...
- [#286](https://github.com/marko-js/vite/pull/286) [`22a4f80`](https://github.com/marko-js/vite/commit/22a4f800aa1bf75f5a4071d9b1256e0ca72b2f73) Thanks [@DylanPiercey](https://github.com/DylanPiercey)! - Carry a template's explicit bare `import "x"` side effect marking downstream to the modules `x` itself imports. Previously only `x` was exempt from the client build's side effect free default, so a package whose effect lives in a module it bare-imports (eg terser installing `AST_Toplevel#resolve_defines` from `import "./global-defs.js"`) still had that module shaken out. Marko files, styles and assets remain non-propagating, so a template's own imports stay shakeable.
...
- [#268](https://github.com/marko-js/vite/pull/268) [`963264a`](https://github.com/marko-js/vite/commit/963264a3075d638dedb83005cb51c495222ef155) Thanks [@rturnq](https://github.com/rturnq)! - Improve default import helper for commonjs translation in dev SSR
...
- [#246](https://github.com/marko-js/vite/pull/246) [`5dfc20b`](https://github.com/marko-js/vite/commit/5dfc20b4799ab236a18362bafd20cd522035ac7a) Thanks [@DylanPiercey](https://github.com/DylanPiercey)! - Bump vite peer dep to support vite 8.
